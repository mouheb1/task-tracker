// -- ./src/template/task-board/task.tsx
'use client'
...
import { Card, CardContent, CardFooter, CardHeader } from 'src/template/ui/card'
...
import { deleteTaskAction, updateTaskAction } from 'src/action/project-action'
