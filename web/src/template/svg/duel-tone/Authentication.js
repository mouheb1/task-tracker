// -- ./src/template/svg/duel-tone/Authentication.js
import * as React from 'react'
const SvgAuthentication = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M9.333 22c0 .737.597 1.334 1.334 1.334H20a1.333 1.333 0 0 0 0-2.667h-9.333c-.737 0-1.334.597-1.334 1.333M9.333 16c0 .737.597 1.334 1.334 1.334H16a1.333 1.333 0 0 0 0-2.667h-5.333c-.737 0-1.334.597-1.334 1.333M27.882 10.97c-1.92.482-4.186.514-6.144-.084a2.7 2.7 0 0 1-1.752-1.717c-.696-2.04-.868-4.538-.357-6.46 0 0 1.632.624 4.632 3.624s3.62 4.636 3.62 4.636"
    />
  </svg>
)
