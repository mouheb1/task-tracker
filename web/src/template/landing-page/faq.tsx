// -- ./src/template/landing-page/faq.tsx
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
} from "src/template/ui/accordion";
            ...
            <Accordion type="single" collapsible className="space-y-6" >
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  A <Link href="https://themeforest.net/licenses/terms/regular" target="_blank" className="text-primary">Regular License</Link>  is designed for a single end-product that is free for end-s.
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  ...
                  is needed for a single end-product that involves charging end-s, such as with a subscription model or in a marketplace.
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  If your SaaS application charges s, you'll need an Extended License for each end product.
