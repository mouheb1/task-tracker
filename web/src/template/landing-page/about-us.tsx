// -- ./src/template/landing-page/about-us.tsx
'use client'
import { Icon } from '@iconify/react'
// import Image from "next/image"
import label1 from 'src/public/images/landing-page/auth-label-1.png'
import label2 from 'src/public/images/landing-page/author-label-2.png'
import label3 from 'src/public/images/landing-page/label-3.png'
import label4 from 'src/public/images/landing-page/label-4.png'
import label5 from 'src/public/images/landing-page/label-5.png'
import featured from 'src/public/images/landing-page/featured.png'
    ...
    <section className="bg-[#F8F4F3] dark:bg-card pt-16 2xl:pt-[120px]">
      ...
      <div className="mt-12 flex justify-center items-center gap-3 lg:gap-16 px-3">
        {data.map((item, index) => (
          ...
          >
            <div
              className={cn('w-8 h-10 md:w-fit md:h-fit', {
                'w-10 h-14 md:w-fit md:h-fit': index == 2,
              })}
            >
              <img src={item.image} alt="image" />
            </div>
            <p className="text-xs lg:text-base font-medium text-default-700 mt-1 lg:mt-4">
              {item.title}
            </p>
          </div>
        ))}
      ...
      <div className="mt-12 flex flex-wrap justify-center gap-9 text-center">
        <div className="bg-background border border-primary py-5 px-6 rounded">
          <span className="block text-lg xl:text-2xl font-semibold text-default-900">
            +7 Years
          </span>
          <span className="block mt-1 text-sm font-medium text-default-800 whitespace-nowrap">
            On ThemeForest
          </span>
        </div>
        <div className="bg-background border border-primary py-5 px-6 rounded">
        ...
        <div className="bg-background border border-primary py-5 px-6 rounded">
          ...
          <span className="flex items-center mt-1 text-sm font-medium text-default-800 whitespace-nowrap">
            5 <Icon icon="heroicons:star" className="w-4 h-4 text-yellow-400" />{' '}
            Reviews
          </span>
        </div>
      </div>
