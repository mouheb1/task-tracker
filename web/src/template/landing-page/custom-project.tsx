// -- ./src/template/landing-page/custom-project.tsx
'use client'
...
import 'swiper/css'
import acculance from 'src/public/images/landing-page/acculance.png'
import acculanceSass from 'src/public/images/landing-page/acculance-sass.png'
import productify from 'src/public/images/landing-page/productify.png'
import konst from 'src/public/images/landing-page/konst.jpg'
import ferarri from 'src/public/images/landing-page/ferrari.jpg'
import onlineAdvisor from 'src/public/images/landing-page/online-advisor.png'
import minor from 'src/public/images/landing-page/minor.jpg'
import dashcode from 'src/public/images/landing-page/dashcode.png'
      ...
      <div className="max-w-[670px] mx-auto">
        ...
        <div className="flex justify-center gap-8 mb-10 xl:mb-[72px] mt-7 xl:mt-9">
          <Button variant="outline" asChild>
            <Link
              href="https://themeforest.net//codeshaperbd"
              target="_blank"
            >
              {' '}
              Take a Tour
