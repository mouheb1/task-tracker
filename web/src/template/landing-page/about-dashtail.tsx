// -- ./src/template/landing-page/about-dashtail.tsx
import icon1 from 'src/public/images/landing-page/icon-1.png'
import icon2 from 'src/public/images/landing-page/icon-2.png'
import icon3 from 'src/public/images/landing-page/icon-3.png'
import icon4 from 'src/public/images/landing-page/icon-4.png'
import icon5 from 'src/public/images/landing-page/icon-5.png'
import icon6 from 'src/public/images/landing-page/icon-6.png'
import icon7 from 'src/public/images/landing-page/icon-7.png'
import icon8 from 'src/public/images/landing-page/icon-8.png'
import icon9 from 'src/public/images/landing-page/icon-9.png'
import icon10 from 'src/public/images/landing-page/icon-10.png'
import icon11 from 'src/public/images/landing-page/icon-11.png'
import icon12 from 'src/public/images/landing-page/icon-12.png'
  ...
  const data = [
    {
      ...
      desc: 'Crafted with the end- in mind, ensuring a smooth, intuitive, and engaging interface that enhances overall productivity and satisfaction.',
      icon: icon1,
    },
    {
      id: 2,
      ...
      <div className="container">
        <div className="max-w-[670px] mx-auto">
          ...
          <p className="text-base xl:leading-7 text-center text-default-700 ">
            Transform your development experience with our ultra-customizable,
            developer-friendly admin template: crafting exceptional
