// -- ./src/template/partials/sidebar/common/add-block.tsx
'use client'
...
import thumbnail from 'src/public/images/all-img/thumbnail.png'
import { Button } from 'src/template/ui/button'
import { Dialog, DialogContent } from 'src/template/ui/dialog'
const AddBlock = ({
  className,
  image = thumbnail,
    ...
    <>
      ...
      >
        ...
        <div className="mt-4 relative">
          <img src={image} alt="footer-thumbnail" className="w-full h-full" />
          <Button
            size="icon"
            type="button"
            color="secondary"
