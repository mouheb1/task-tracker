// -- ./src/template/partials/sidebar/common/multi-nested-menu.tsx
...
import { cn, isLocationMatch, translate, getDynamicPath } from "src/lib/utils";
...
const MultiNestedMenu = ({ subItem, subIndex, activeMultiMenu, trans }: {
  ...
  const locationName = getDynamicPath('/'); // fix with pathname
  return (
