// -- ./src/template/partials/sidebar/module/single-icon-menu.tsx
...
import { translate } from "src/lib/utils";
            ...
            {href ? (
              ...
              <button
                className={cn(
                  "h-12 w-12 mx-auto rounded-md transition-all duration-300 flex flex-col items-center justify-center cursor-pointer relative  ",
                  {
                    "bg-primary/10 dark:bg-primary dark:text-primary-foreground   data-[state=delayed-open]:bg-primary/10 ":
                      activeIndex === index,
